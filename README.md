...
Этапы 1–6 реализованы и проверены. Frontend этапа 3 опубликован; приглашение и
выход проверены пользователем двумя Telegram-аккаунтами 09.09.2026. Публикация
актуального frontend выполняется только отдельным ручным workflow Pages.
Реальная Telegram-приёмка расходов этапа 4 и расчётов этапа 5 подтверждена
